...
class systematic(Resource):
    # Endpoint that checks gul-signalvej for a specific mac address
    ...
    # Endpoint that checks gul-signalvej for any mac address
    def get(self, seconds):
        """
        1. Make a SOAP-request with MATCH_objectClass instead of MATCH_epc
        2. The response contains >1000 tags. Iterate over all tags and check if any tags has a
           <recordTime> that is newer than the <seconds> parameter.
           - If any matches, return OK (success)
           - Otherwise if no tags have been updated within threshold, return FAIL (failure)
        """
        try:
    ...
    <s:Body xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
        ...
        # Look for ObjectEvent-elements – can be with or without namespace
